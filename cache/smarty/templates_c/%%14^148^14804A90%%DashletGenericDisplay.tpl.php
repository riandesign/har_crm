<?php /* Smarty version 2.6.31, created on 2019-07-13 15:47:20
            ...
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                <tr>
                    ...
                    <td align='right' nowrap='nowrap'>
                        <?php if (isset ( $this->_tpl_vars['pageData']['urls']['startPage'] ) && $this->_tpl_vars['pageData']['urls']['startPage']): ?>
...
?>
            <?php if ($this->_tpl_vars['colCounter'] == '1'): ?><?php $this->assign('datahide', 'phone'); ?><?php endif; ?>
...
'>
                <?php if (((is_array($_tmp=@$this->_tpl_vars['params']['sortable'])) ? $this->_run_mod_handler('default', true, $_tmp, true) : smarty_modifier_default($_tmp, true))): ?>
					<!-- dashlet: <?php echo $this->_tpl_vars['dashletId']; ?>
 -->
	                <a href='#' onclick='return SUGAR.mySugar.retrieveDashlet("<?php echo $this->_tpl_vars['dashletId']; ?>
", "<?php echo $this->_tpl_vars['pageData']['urls']['orderBy']; ?>
...
", false, false, true, $(this).closest("div[id^=pageNum_][id$=_div]").parent().parent())' class='listViewThLinkS1' title="<?php echo $this->_tpl_vars['arrowAlt']; ?>
...
?>
			    <?php echo '<td scope=\'row\' align=\''; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['params']['align'])) ? $this->_run_mod_handler('default', true, $_tmp, 'left') : smarty_modifier_default($_tmp, 'left')); ?><?php echo '\' valign="top" '; ?><?php if (( $this->_tpl_vars['params']['type'] == 'teamset' )): ?><?php echo 'class="nowrap"'; ?><?php endif; ?><?php echo '>'; ?><?php if ($this->_tpl_vars['col'] == 'NAME' || $this->_tpl_vars['params']['bold']): ?><?php echo '<b>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['params']['link'] && ! $this->_tpl_vars['params']['customCode']): ?><?php echo '<'; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']][$this->_tpl_vars['params']['ACLTag']])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN'])); ?><?php echo ' href=\'index.php?action='; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['params']['action'])) ? $this->_run_mod_handler('default', true, $_tmp, 'DetailView') : smarty_modifier_default($_tmp, 'DetailView')); ?><?php echo '&module='; ?><?php if ($this->_tpl_vars['params']['dynamic_module']): ?><?php echo ''; ?><?php echo $this->_tpl_vars['rowData'][$this->_tpl_vars['params']['dynamic_module']]; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['params']['module'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['pageData']['bean']['moduleDir']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['pageData']['bean']['moduleDir'])); ?><?php echo ''; ?><?php endif; ?><?php echo '&record='; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['rowData'][$this->_tpl_vars['params']['id']])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['rowData']['ID']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['rowData']['ID'])); ?><?php echo '&offset='; ?><?php echo $this->_tpl_vars['pageData']['offsets']['current']+$this->_foreach['rowIteration']['iteration']; ?><?php echo '&stamp='; ?><?php echo $this->_tpl_vars['pageData']['stamp']; ?><?php echo '\'>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['params']['customCode']): ?><?php echo ''; ?><?php echo smarty_function_sugar_evalcolumn_old(array('var' => $this->_tpl_vars['params']['customCode'],'rowData' => $this->_tpl_vars['rowData']), $this);?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo smarty_function_sugar_field(array('parentFieldArray' => $this->_tpl_vars['rowData'],'vardef' => $this->_tpl_vars['params'],'displayType' => 'ListView','field' => $this->_tpl_vars['col']), $this);?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if (empty ( $this->_tpl_vars['rowData'][$this->_tpl_vars['col']] ) && empty ( $this->_tpl_vars['params']['customCode'] )): ?><?php echo '&nbsp;'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['params']['link'] && ! $this->_tpl_vars['params']['customCode']): ?><?php echo '</'; ?><?php echo ((is_array($_tmp=@$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']][$this->_tpl_vars['params']['ACLTag']])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['pageData']['tag'][$this->_tpl_vars['id']]['MAIN'])); ?><?php echo '>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['col'] == 'NAME' || $this->_tpl_vars['params']['bold']): ?><?php echo '</b>'; ?><?php endif; ?><?php echo '</td>'; ?>
...
<?php $this->_smarty_vars['capture']['tmp1'] = ob_get_contents();  $this->assign('alt_edit', ob_get_contents());ob_end_clean(); ?>
                    <?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_VIEWINLINE'), $this);?>
<?php $this->_smarty_vars['capture']['tmp1'] = ob_get_contents();  $this->assign('alt_view', ob_get_contents());ob_end_clean(); ?>
                    <a title='<?php echo $this->_tpl_vars['editLinkString']; ?>
' class="list-view-data-icon" href='index.php?action=EditView&module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
...
&return_module=Home&return_action=index'> <span class="suitepicon suitepicon-action-edit"></span></a>
				<?php endif; ?>
				<?php if ($this->_tpl_vars['pageData']['access']['view']): ?>
                <a title='<?php echo $this->_tpl_vars['viewLinkString']; ?>
' class="list-view-data-icon" href='index.php?action=DetailView&module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
